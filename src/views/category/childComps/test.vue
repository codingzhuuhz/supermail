...
export default {
  name: "test",
  data(){
    return {gname:'',storenum:'',gnewprice:'',goldprice:'',sellnum:'',gintroduce:'',file:'',topfile:[],introfile:[],type:''}
  },
  methods:{
  submit(){
    ...
    this.$http.post("http://localhost:8080/cors/getAddGoodInfo",formData,{emulateJSON:true}).then(response => {
